"""Топ дня: топ-10 самых EV ставок дня по всем матчам.
...
букмекера достаточно высок относительно нашей оценки, ставка EV.
...
async def top_day_cb(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    if rendered == 0:
        parts.append(
            "Сегодня пока нет EV-беты в кэше прогнозов.\n"
